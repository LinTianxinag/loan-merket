...
import com.fuhui.common.support.jedis.Executor;
import com.fuhui.common.support.jedis.JedisTemplate;
...
public final class RedisUtil {
	...
	public static final String setStr(final String key, final Integer seconds, final String value) {
		return JedisTemplate.run(key, new Executor<String>() {
			@Override
			public String execute(ShardedJedis jedis) {
	...
	public static final Double hincrByFloat(final String key, final String field, final double value) {
		return JedisTemplate.run(key, new Executor<Double>() {
			public Double execute(ShardedJedis jedis) {
