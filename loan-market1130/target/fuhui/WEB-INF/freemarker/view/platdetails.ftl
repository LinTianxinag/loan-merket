...
<#include "./menu.ftl">
    <body>
    <form id="formid" method="post"  name="formid" action = "/plat/update">
        <div id="jiekubox">
            <div class="jiekutop">
                <h2>借款参数</h2>
                ...
                <div class="jiekudown_wrap">
                    ...
                    <div class="jiekudown3">
                        ...
                        <#if platform.onshelves== 1>
                            <label for="yestwo">
                                <input type="radio" name="itemtwo" id="yestwo" value="1"  />
                                已下架
                            </label>
                            <label for="notwo">
                                <input type="radio" name="itemtwo" value="0" id="notwo" checked/>
                                已上架
                            </label>
                    ...
                    <div class="jiekudown6">
                        <input type="submit"  class="jiekubtn" value="点击更新"/>
                    </div>
                </div>
            </div>
        </div>
